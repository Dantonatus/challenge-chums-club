...
export function GanttPage() {
  ...
  const { tasks, milestones, isLoading: tasksLoading, updateTask, reorderTasks } = useGanttTasks(selectedProjectId || undefined);
  ...
  const handleTaskReorder = (reordered: { id: string; sort_order: number }[]) => {
